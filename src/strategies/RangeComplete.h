...
class RangeComplete
{
  private:
    ...
    // Let's say one Strategy has 2-3 tricks and the lowest Winner
    // for 3 tricks is 4N.  Another strategy has 3 tricks and the
    // highest winner is 6NS.  Then the defense would never choose the
    ...
    // 1. The lowest winner at the highest number of tricks, vs.
    // 2. The highest winner at the lowest number of tricks.
