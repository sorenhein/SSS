...
enum SentencesEnum: unsigned
{
  ...
  SENTENCE_EXACT_COUNT_ONETOP = 3,
  SENTENCE_TOPS_LENGTH = 4,
  SENTENCE_TOPS_LENGTH_OLD = 5,
  SENTENCE_TOPS_BOTH_LENGTH = 6,
  SENTENCE_TOPS_BOTH_SYMM = 7,
  SENTENCE_TOPS_BOTH_NOT_SYMM = 8,
  SENTENCE_TOPS_AND_XES = 9,
  SENTENCE_TOPS_AND_LOWER = 10,
  SENTENCE_TOPS_AND_BELOW = 11,
  SENTENCE_ONLY_BELOW = 12,
  SENTENCE_SINGULAR_EXACT = 13,
  SENTENCE_HONORS_ORDINAL = 14,
  SENTENCE_LIST = 15,
  SENTENCE_SET_UNSET = 16,
  SENTENCE_TOPS_LENGTH_OLDER = 17,
  SENTENCE_TOPS_AND_LOWER_NEW = 18,
