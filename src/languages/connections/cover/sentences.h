...
enum SentencesEnum: unsigned
{
  ...
  SENTENCE_COUNT_OF_TOPS_ORDINAL = 3,
  ...
  SENTENCE_TOPS_MAYBE_OTHERS = 14,
  SENTENCE_TOPS_AND_XES = 15,
  SENTENCE_EXACTLY_LIST = 16,
  SENTENCE_2SPLIT_TOPS_SYMM = 17,
  SENTENCE_2SPLIT_TOPS_ASYMM = 18,
  SENTENCE_2SPLIT_TOPS_DIGITS_SYMM = 19,
  SENTENCE_2SPLIT_TOPS_DIGITS_ASYMM = 20,
  SENTENCE_SIZE = 21
};
