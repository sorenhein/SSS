...
enum BlankOneTopPhrase: unsigned
{
  BLANK_ONETOP_PHRASE_ONE_AND_ONLY = 0,
  BLANK_ONETOP_PHRASE_ALL = 1,
  BLANK_ONETOP_PHRASE_EXACT = 2,
  BLANK_ONETOP_PHRASE_NUMBER_OF = 3
};
