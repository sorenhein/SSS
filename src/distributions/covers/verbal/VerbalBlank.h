...
{
  XLENGTH_ORDINAL_EXACT = 0,
  XLENGTH_ORDINAL_ATMOST = 1,
  XLENGTH_ORDINAL_23 = 2
};
...
{
  XLIST_HOLDING_EXACT = 0,
  XLIST_HOLDING_WITH_LOWS = 1
};
...
enum LengthVerb: unsigned
{
  XLENGTH_VERB_VOID = 0,
  XLENGTH_VERB_XTON = 1,
  XLENGTH_VERB_EVENLY = 2,
  XLENGTH_VERB_ODD_EVENLY = 3,
  XLENGTH_VERB_XTON_ATMOST = 4,
  XLENGTH_VERB_CARDS = 5,
  XLENGTH_VERB_CARDS_ATMOST = 6,
  XLENGTH_VERB_RANGE = 7,
  XLENGTH_VERB_SPLIT = 8
};
